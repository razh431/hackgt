...
# =========================================================================================================================================
SKILL_NAME = "accessibility reader"
...
def getInfo(aUrl):
    api_url = "https://api.smmry.com/&SM_API_KEY=4A8253FEDC&SM_URL={}".format(aUrl)
...
data = [
  getInfo('https://www.bbc.com/news/world-us-canada-49694453'),
]
